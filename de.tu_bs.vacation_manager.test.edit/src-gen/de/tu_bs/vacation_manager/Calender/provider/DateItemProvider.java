...
/**
 * This is the item provider adapter for a {@link de.tu_bs.vacation_manager.Calender.Date} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DateItemProvider 
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Date_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Date_name_feature", "_UI_Date_type"),
				 CalenderPackage.Literals.DATE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPersonsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Date_persons_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Date_persons_feature", "_UI_Date_type"),
				 CalenderPackage.Literals.DATE__PERSONS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Date)object).getName();
	...
	public ResourceLocator getResourceLocator() {
		return CalenderEditPlugin.INSTANCE;
	}
