 ...
 * @generated
 */
public class CalenderSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CalenderPackage.CALENDER: {
				Calender calender = (Calender)theEObject;
				T result = caseCalender(calender);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalenderPackage.DATE: {
				Date date = (Date)theEObject;
				T result = caseDate(date);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalenderPackage.PERSON: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Calender</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Calender</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCalender(Calender object) {
		return null;
	}
